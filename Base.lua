...
local fontUrls = {
	["Smallest Pixel-7"] = "https://github.com/JUMPINGISACRIME/fonts/raw/refs/heads/main/smallest_pixel-7.ttf",
	["Proggy Clean"] = "https://github.com/JUMPINGISACRIME/fonts/raw/refs/heads/main/ProggyClean.ttf",
	["Proggy Tiny"] = "https://github.com/JUMPINGISACRIME/fonts/raw/refs/heads/main/ProggyTiny.ttf",
	["Minecraftia"] = "https://github.com/JUMPINGISACRIME/fonts/raw/refs/heads/main/Minecraftia-Regular.ttf",
	["Tahoma Bold"] = "https://github.com/JUMPINGISACRIME/fonts/raw/refs/heads/main/tahoma_bold.ttf",
	["Fortnite"] = "https://github.com/JUMPINGISACRIME/fonts/raw/refs/heads/main/fortnite.otf"
}

local asssssd = {}
for name in pairs(fontUrls) do
	table.insert(asssssd, name)
end
table.insert(asssssd, "Tahoma")
...
function library:indicator()
	...
	do
		...
		library:create( "UIGradient" , {
			...
			Parent = items.Shadow;
			Color = rgbseq{
				rgbkey(0, rgb(150, 150, 150)),
				rgbkey(1, rgb(150, 150, 150))
			}
		});
		items.holder = library:create( "Frame" , {
			Parent = items.LowContrast;
	...
	function cfg.change_profile(player)
		items.label.set(string.format("Player: %s", player.DisplayName))
...
function library:window(properties)
	...
	local watermark = library:watermark({
		default = os.date('Atlanta')
	})
	task.spawn(function()
		while task.wait(1) do
			watermark.change_text(os.date('Atlanta'))
		end
	end)
...
function library:playerlist(options)
	...
	function cfg.create_player(player)
		...
		local priority_text = library:create("TextLabel", {
			...
			Name = "",
			FontFace = library.font,
			TextColor3 = tostring(player) ~= lp.Name and themes.preset.text or rgb(44, 160, 204),
			BorderColor3 = rgb(0, 0, 0),
